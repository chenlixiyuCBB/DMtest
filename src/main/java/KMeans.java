...
public class KMeans {
    ...
    //样本数目（测试集）
    final static int InstanceNumber = 75;
    //样本属性数目（测试）
    ...
    public static void main(String[] args) {
        ...
        //读取数据
        cluster.readData("/Users/xiyuchenli/Downloads/数据挖掘/数据挖掘/数据/forKNN/iris.2D.test1.txt");
        //聚类过程
        cluster.cluster();
        //输出结果
        cluster.printResult("/Users/xiyuchenli/Downloads/数据挖掘/数据挖掘/数据/forKNN/kmeams.txt");
